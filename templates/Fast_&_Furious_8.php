...
<head>
	...
	<link rel="stylesheet" href="css/Fast_&_Furious_8.css">
...
<script type="text/javascript">
	...
	function getinfo()
	{
		...
		xhr.open("get","php/Fast_&_Furious_8/get_Fast_&_Furious_8.php",true);
		xhr.send(null);
	}
	...
	function putreview()
	{
		...
		if(f!="")
		{
			...
			xhr1.open("get","php/Fast_&_Furious_8/put_in_Fast_&_Furious_8.php?data="+f+"&name="+user,true);
			xhr1.send(null);
	...
	function check()
	{
		var ev = new EventSource("php/Fast_&_Furious_8/check_change_in_Fast_&_Furious_8.php");
...
<body style="background-color:#FFA500;" onload="getinfo()">
	<?php
		...
		echo "</script>";
	?>
	<div><center><h1>Fast_&_Furious_8</h1></center> 
	...
	<div class="row">
	    ...
	    <b>Description</b>: When a mysterious woman seduces Dom into the world of crime and a betrayal of those closest to him, the crew face trials that will test them as never before..<br>
	   	<b>Director</b>: F. Gary Gray<br>
		<b>Stars</b>: Scott Eastwood, Charlize Theron, Dwayne Johnson
	    </center>
	    </div>

	    <div class="col-sm-6"  id="t" style="background-color: #FF6347;border-left: thick solid black;height:400;" >
	    	<br><br>
	    		<center><img height="250px" width="300px" src="images/Fast_&_Furious_8.jpg" alt="Fast_&_Furious_8 jaan photo"></center>
	    </div>
