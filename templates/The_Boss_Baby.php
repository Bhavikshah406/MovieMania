...
<head>
	...
	<link rel="stylesheet" href="css/The_Boss_Baby.css">
...
<script type="text/javascript">
	...
	function getinfo()
	{
		...
		xhr.open("get","php/The_Boss_Baby/get_The_Boss_Baby.php",true);
		xhr.send(null);
	}
	...
	function putreview()
	{
		...
		if(f!="")
		{
			...
			xhr1.open("get","php/The_Boss_Baby/put_in_The_Boss_Baby.php?data="+f+"&name="+user,true);
			xhr1.send(null);
	...
	function check()
	{
		var ev = new EventSource("php/The_Boss_Baby/check_change_in_The_Boss_Baby.php");
...
<body style="background-color:#FFA500;" onload="getinfo()">
	<?php
		...
		echo "</script>";
	?>
	<div><center><h1>The_Boss_Baby</h1></center> 
	...
	<div class="row">
	    ...
	    <b>Description</b>: A suit-wearing briefcase-carrying baby pairs up with his seven-year old brother to stop the dastardly plot of the CEO of Puppy Co.<br>
	   	<b>Director</b>: Tom McGrath<br>
		<b>Stars</b>: Alec Baldwin, Steve Buscemi, Jimmy Kimmel 
	    </center>
	    </div>

	    <div class="col-sm-6"  id="t" style="background-color: #FF6347;border-left: thick solid black;height:400;" >
	    	<br><br>
	    		<center><img height="250px" width="300px" src="images/The_Boss_Baby.jpg" alt="The_Boss_Baby jaan photo"></center>
	    </div>
