<?php
	...
	//$f=fopen("Baahubali_2_reviews.txt","r");
	//$file=fread($f,filesize("Baahubali_2_reviews.txt"));
	...
	{
		$oldtime = filemtime("../../info/Baahubali_2_reviews.txt");
	}
	
	while(true)
	{
		clearstatcache();
		$newtime = filemtime("../../info/Baahubali_2_reviews.txt");
		...
		if($newtime != $oldtime)
		{
			...
			$msgarr = file("../../info/Baahubali_2_reviews.txt");
