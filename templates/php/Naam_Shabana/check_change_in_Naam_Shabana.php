<?php
	...
	//$f=fopen("Naam_Shabana_reviews.txt","r");
	//$file=fread($f,filesize("Naam_Shabana_reviews.txt"));
	...
	{
		$oldtime = filemtime("../../info/Naam_Shabana_reviews.txt");
	}
	
	while(true)
	{
		clearstatcache();
		$newtime = filemtime("../../info/Naam_Shabana_reviews.txt");
		...
		if($newtime != $oldtime)
		{
			...
			$msgarr = file("../../info/Naam_Shabana_reviews.txt");
