<?php
	...
	//$f=fopen("Fast_&_Furious_8_reviews.txt","r");
	//$file=fread($f,filesize("Fast_&_Furious_8_reviews.txt"));
	...
	{
		$oldtime = filemtime("../../info/Fast_&_Furious_8_reviews.txt");
	}
	
	while(true)
	{
		clearstatcache();
		$newtime = filemtime("../../info/Fast_&_Furious_8_reviews.txt");
		...
		if($newtime != $oldtime)
		{
			...
			$msgarr = file("../../info/Fast_&_Furious_8_reviews.txt");
