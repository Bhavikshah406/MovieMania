<?php
	...
	//$f=fopen("Ghost_in_the_Shell_reviews.txt","r");
	//$file=fread($f,filesize("Ghost_in_the_Shell_reviews.txt"));
	...
	{
		$oldtime = filemtime("../../info/Ghost_in_the_Shell_reviews.txt");
	}
	
	while(true)
	{
		clearstatcache();
		$newtime = filemtime("../../info/Ghost_in_the_Shell_reviews.txt");
		...
		if($newtime != $oldtime)
		{
			...
			$msgarr = file("../../info/Ghost_in_the_Shell_reviews.txt");
