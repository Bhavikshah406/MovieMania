...
<head>
	...
	<link rel="stylesheet" href="css/Ghost_in_the_Shell.css">
...
<script type="text/javascript">
	...
	function getinfo()
	{
		...
		xhr.open("get","php/Ghost_in_the_Shell/get_Ghost_in_the_Shell.php",true);
		xhr.send(null);
	}
	...
	function putreview()
	{
		...
		if(f!="")
		{
			...
			xhr1.open("get","php/Ghost_in_the_Shell/put_in_Ghost_in_the_Shell.php?data="+f+"&name="+user,true);
			xhr1.send(null);
	...
	function check()
	{
		var ev = new EventSource("php/Ghost_in_the_Shell/check_change_in_Ghost_in_the_Shell.php");
...
<body style="background-color:#FFA500;" onload="getinfo()">
	<?php
		...
		echo "</script>";
	?>
	<div><center><h1>Ghost_in_the_Shell</h1></center>
	...
	<div class="row">
	    ...
	    <b>Description</b>: In the near future, Major is the first of her kind: A human saved from a terrible crash, who is cyber-enhanced to be a perfect soldier devoted to stopping the world's most dangerous criminals.<br>
	   	<b>Director</b>: Rupert Sanders<br>
		<b>Stars</b>: Scarlett Johansson, Pilou Asbæk, Takeshi Kitano
	    </center>
	    </div>

	    <div class="col-sm-6"  id="t" style="background-color: #FF6347;border-left: thick solid black;height:400;" >
	    	<br><br>
	    		<center><img height="250px" width="300px" src="images/Ghost_in_the_Shell.jpg" alt="Ghost_in_the_Shell photo"></center>
	    </div>
