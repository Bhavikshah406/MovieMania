...
<head>
	...
	<link rel="stylesheet" href="css/Baahubali_2.css">
...
<script type="text/javascript">
	...
	function getinfo()
	{
		...
		xhr.open("get","php/Baahubali_2/get_Baahubali_2.php",true);
		xhr.send(null);
	}
	...
	function putreview()
	{
		...
		if(f!="")
		{
			...
			xhr1.open("get","php/Baahubali_2/put_in_Baahubali_2.php?data="+f+"&name="+user,true);
			xhr1.send(null);
	...
	function check()
	{
		var ev = new EventSource("php/Baahubali_2/check_change_in_Baahubali_2.php");
...
<body style="background-color:#FFA500;" onload="getinfo()">
	<?php
		...
		echo "</script>";
	?>
	<div><center><h1>Baahubali_2</h1></center>
	...
	<div class="row">
	    ...
	    <b>Description</b>: When Shiva, the son of Bahubali, learns about his heritage, he begins to look for answers. His story is juxtaposed with past events that unfolded in the Mahishmati Kingdom.<br>
	   	<b>Director</b>: S.S. Rajamouli<br>
		<b>Stars</b>: Prabhas, Rana Daggubati, Anushka Shetty
	    </center>
	    </div>

	    <div class="col-sm-6"  id="t" style="background-color: #FF6347;border-left: thick solid black;height:400;" >
	    	<br><br>
	    		<center><img height="250px" width="300px" src="images/Baahubali_2.jpg" alt="Baahubali_2  photo"></center>
	    </div>
